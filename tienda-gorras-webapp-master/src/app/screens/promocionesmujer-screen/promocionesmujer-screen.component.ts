...
@Component({
  selector: 'app-promocionesmujer-screen',
  templateUrl: './promocionesmujer-screen.component.html',
  styleUrls: ['./promocionesmujer-screen.component.scss']
})
export class PromocionesmujerScreenComponent {
  constructor(
