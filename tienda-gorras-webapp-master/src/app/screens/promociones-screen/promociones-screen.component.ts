...
@Component({
  selector: 'app-promociones-screen',
  templateUrl: './promociones-screen.component.html',
  styleUrls: ['./promociones-screen.component.scss']
})
export class PromocionesScreenComponent {
