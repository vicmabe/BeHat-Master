...
@Component({
  selector: 'app-promocioneshombre-screen',
  templateUrl: './promocioneshombre-screen.component.html',
  styleUrls: ['./promocioneshombre-screen.component.scss']
})
export class PromocioneshombreScreenComponent {
